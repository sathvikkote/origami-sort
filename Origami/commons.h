...
typedef __m128i avx2;
typedef __m128	avx2f;
typedef __m128d avx2d;
typedef __m128i avx512;
typedef __m128	avx512f;
typedef __m128d avx512d;

// Added typedef to support on m1
...
#define VFREE(ptr,sz)			(munmap(ptr, sz))
